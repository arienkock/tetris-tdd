...
})()(
  {
    1: [
      function (require, module, exports) {
        ...
        const playArea =
          '<table class="area">' +
          generateTableGrid(width, height) +
          "</table>";
        const previewArea =
    ...
    <div class="score-entries"></div>
        ...
        function paint() {
          ...
          const offsetX = Math.floor(
            (PREVIEW_AREA_SIZE - game.nextShape.width) / 2
          );
          const offsetY = Math.floor(
            (PREVIEW_AREA_SIZE - game.nextShape.height) / 2
          );
    ...
    2: [
      function (require, module, exports) {
        ...
        function Tetris({
          ...
          let ticksPerDropAccordingToLevel =
            gameSpeeds[gameSpeeds.length - 1][1];
          ...
          const setGameSpeed = () => {
            if (this.score.level > 28) {
              ...
              const [, speed] = gameSpeeds.find(
                ([level]) => this.score.level >= level
              );
